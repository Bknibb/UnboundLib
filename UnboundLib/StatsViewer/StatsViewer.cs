...
namespace UnboundLib.StatsViewer
{
    static class StatsViewer
    {
        ...
        public static Dictionary<string, Func<StatsArgs, string>> GunStats = new Dictionary<string, Func<StatsArgs, string>>()
        {
            ...
            { "Calculated Damage", (args) => ProcessStat(args.projectileNum.HasValue ? Mathf.Max(args.playerGun.damage * (1f - args.projectileNum.Value * (1f - args.cardGun.damage)), 0.25f) * args.cardGun.bulletDamageMultiplier : (float?)null, args.playerGun.damage * args.playerGun.bulletDamageMultiplier, StatsArgs.defaultGun.damage * StatsArgs.defaultGun.bulletDamageMultiplier, StatsBetter.More, ChangeMode.Set) },
            ...
            { "Don't Allow Auto Fire", (args) => ProcessStat((args.cardGun && args.cardGun.dontAllowAutoFire) ? true : (bool?)null, args.playerGun.dontAllowAutoFire, StatsArgs.defaultGun.dontAllowAutoFire, StatsBetter.False) },
